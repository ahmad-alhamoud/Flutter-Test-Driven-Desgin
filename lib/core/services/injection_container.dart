...
import 'package:tdd_clean_architecture/src/authentication/data/repositories/authentication_repository_implemention.dart';
...
import 'package:tdd_clean_architecture/src/authentication/presentation/cubit/authentication_cubit.dart';
...
Future<void> init() async {
  ...
  sl
   // App Logic
    ...
    ..registerLazySingleton(() => CreateUser(sl()))..registerLazySingleton(() =>
      GetUsers(sl()))
